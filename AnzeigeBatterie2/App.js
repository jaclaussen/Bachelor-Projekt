...
.directive('anzeigeBatterie2', ['StreamsManager', '$interval', function (StreamsManager, $interval) {
  return {
    templateUrl: 'modules/apps/AnzeigeBatterie2/app.html',
    replace: true,
    restrict: 'EA',
    scope: true,
	...
	$scope.verbrauch = "0";
		...
		$scope.$evalAsync(function () {
			...
			// Calculate mean to more even movements of the display
